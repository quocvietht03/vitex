...
$fullwidth = isset($vitex_options['single_team_fullwidth'])&&$vitex_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($vitex_options['single_team_sidebar_width']) ?  $vitex_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($vitex_options['single_team_titlebar']) ? $vitex_options['single_team_titlebar']: true;
if($single_team_titlebar) vitex_titlebar();
?>
