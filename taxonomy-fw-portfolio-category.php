...
$fullwidth = isset($vitex_options['portfolio_fullwidth'])&&$vitex_options['portfolio_fullwidth'] ? 'fullwidth': 'container';
$columns = (int) isset($vitex_options['portfolio_columns']) ?  $vitex_options['portfolio_columns']: 1;
$sidebar_width = (int) isset($vitex_options['portfolio_sidebar_width']) ?  $vitex_options['portfolio_sidebar_width']: 3;
...
$portfolio_titlebar = isset($vitex_options['portfolio_titlebar']) ? $vitex_options['portfolio_titlebar']: true;
if($portfolio_titlebar) vitex_titlebar();
?>
