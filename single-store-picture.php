...
$fullwidth = isset($vitex_options['single_store_picture_fullwidth'])&&$vitex_options['single_store_picture_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($vitex_options['single_store_picture_sidebar_width']) ?  $vitex_options['single_store_picture_sidebar_width']: 3;
...
$single_store_picture_titlebar = isset($vitex_options['single_store_picture_titlebar']) ? $vitex_options['single_store_picture_titlebar']: true;
if($single_store_picture_titlebar) vitex_titlebar();
?>
