...
$fullwidth = isset($vitex_options['services_fullwidth'])&&$vitex_options['services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($vitex_options['services_sidebar_width']) ?  $vitex_options['services_sidebar_width']: 3;
...
$services_titlebar = isset($vitex_options['services_titlebar']) ? $vitex_options['services_titlebar']: true;
if($services_titlebar) vitex_titlebar();
?>
